            ...
            if file is file:
                try:
                    ...
                    if xmin!=-1 and xmax!=-1:
                        ...
                        path = '/data/train_test_data/train/' + charlabel + '/' + charlabel + '_' + file.replace(".", "_") + ".png"
                        ic.save(path)
...
if __name__ == "__main__":
    ...
    procs = []
    for i in range(40):
        p = multiprocessing.Process(target=printchars, args=(chars, int(i*3500/40), int((i+1)*3500/40)))
        procs.append(p)
